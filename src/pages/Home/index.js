...
const Page = () => {
  const { data } = useData();
  const lastEvent = data && data.events && data.events[data.events.length - 1];
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="ServicesContainer" id="service">
        ...
        <section className="EventsContainer" id="realisation">
          <h2 className="Title">Nos réalisations</h2>
          <EventList />
        </section>
        <section className="PeoplesContainer" id="people">
      ...
      <footer className="row">
        ...
        <div className="col description">
          <Logo size="large" />
          <p>Une agence événementielle propose des prestations de service
          spécialisées dans la conception et l&rsquo;organisation de divers événements
